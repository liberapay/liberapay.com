...
DELETE FROM communities WHERE nmembers = 0;
ALTER TABLE communities DROP CONSTRAINT communities_nmembers_check,
                        ADD CONSTRAINT communities_nmembers_check CHECK (nmembers > 0);
