...
- [Contributing to the source code (including the documentation)](#contributing-to-the-source-code-including-the-documentation)
  - [What to work on](#what-to-work-on)
  - [Introduction to Liberapay's source code](#introduction-to-liberapays-source-code)
...
## Contributing to the source code (including the documentation)

### What to work on

Start by browsing the [open issues](https://github.com/liberapay/liberapay.com/issues), perhaps [by label](https://github.com/liberapay/liberapay.com/labels) to narrow things down.

Once you've found an issue to work on, you should try to make sure that you have all the facts and that no unpushed work exists for that issue, by posting a comment informing everyone that you intend to work on it.

If you have doubts or questions that don't belong in the main issue tracker, you can post them in the [chat room](https://gitter.im/liberapay/salon) or in the [GitHub salon](https://github.com/liberapay/salon).

As a contributor, you'll want to [subscribe to the liberapay.com repository](https://github.com/liberapay/liberapay.com/subscription) to be notified of what the other contributors are doing. You should also [subscribe to the salon](https://github.com/liberapay/salon/subscription) and make sure you have [email notifications](https://github.com/settings/notifications) enabled.

### Introduction to Liberapay's source code
