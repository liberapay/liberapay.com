INSERT INTO app_conf (key, value) VALUES
    ...
    ('bitbucket_consumer_key', '"Fu9aQHB64WdVR7UxY4"'::jsonb),
    ('bitbucket_consumer_secret', '"Y5G6A9BaWDxn2gLKZwwkrGtVE3Zjd7y7"'::jsonb),
    ('bountysource_api_host', '"https://staging-api.bountysource.com"'::jsonb),
    ('bountysource_api_secret', '""'::jsonb),
    ('bountysource_callback', '"http://127.0.0.1:8339/on/bountysource/associate"'::jsonb),
    ('bountysource_www_host', '"https://staging.bountysource.com"'::jsonb),
    ('cache_static', 'false'::jsonb),
    ('check_db_every', '600'::jsonb),
    ('compress_assets', 'false'::jsonb),
    ('dequeue_emails_every', '60'::jsonb),
    ('facebook_app_id', '"1418954898427187"'::jsonb),
    ('facebook_app_secret', '"3bcb5dc6ce821e5202870c1e6ef5bbc4"'::jsonb),
    ...
    ('github_client_id', '"18891d01e40e5aef93b8"'::jsonb),
    ('github_client_secret', '"46f75669895e96029d57b64832d6f2c8e6291a0e"'::jsonb),
    ...
    ('google_client_id', '"547044792904-jikvtdgeigpot9ek7tsb5660t8rp9p77.apps.googleusercontent.com"'::jsonb),
    ('google_client_secret', '"7AkgPekyWr6stQWdM6y1TtV6"'::jsonb),
    ...
    ('openstreetmap_consumer_key', '"w4eQbkobmMzpkJFwS4tM16a3lq9AFbcoNCKNcGBE"'::jsonb),
    ('openstreetmap_consumer_secret', '"W08UgEhxQnh7nMzB7GfSFcqcwPnZMmKMNyxWdcw4"'::jsonb),
    ('password_rounds', '1'::jsonb),
    ('twitter_callback', '"http://127.0.0.1:8339/on/twitter/associate"'::jsonb),
    ('twitter_consumer_key', '"h8bBZtoPNz63S5RkZdbo9R5zb"'::jsonb),
    ('twitter_consumer_secret', '"Jye64vkWxa2dQu64feTnk0BM3j4JO8ZlTa4EQvMDwrweLkwPaw"'::jsonb),
